...
@Component({
  ...
  template: `
    <section class="gallery-section section">
      <div class="container">
        ...
        <p class="section-subtitle fade-in">Witness the artistry of transformation</p>
  ...
  styles: [`
    .gallery-section {
      background: linear-gradient(135deg, var(--cream-white), var(--soft-gray));
      padding: 4rem 0;
    }
    ...
    .gallery-overlay {
      ...
      width: 100%;
      height: 100%;
      background: linear-gradient(135deg, rgba(248, 187, 217, 0.9), rgba(232, 213, 183, 0.9));
      display: flex;
...
export class GalleryComponent implements OnInit {
  ...
  images: GalleryImage[] = [
    ...
    {
      id: 2,
      url: 'https://images.pexels.com/photos/3993445/pexels-photo-3993445.jpeg?auto=compress&cs=tinysrgb&w=800',
      title: 'Classic Bridal Makeup',
      category: 'bridal'
    },
    {
      id: 3,
      url: 'https://images.pexels.com/photos/3785804/pexels-photo-3785804.jpeg?auto=compress&cs=tinysrgb&w=800',
    ...
    {
      id: 7,
      url: 'https://images.pexels.com/photos/3065228/pexels-photo-3065228.jpeg?auto=compress&cs=tinysrgb&w=800',
      title: 'Elegant Updo',
      category: 'hair'
    },
    {
      id: 8,
      url: 'https://images.pexels.com/photos/3065217/pexels-photo-3065217.jpeg?auto=compress&cs=tinysrgb&w=800',
      title: 'Modern Bridal Beauty',
      category: 'bridal'
    },
    {
      id: 9,
      url: 'https://images.pexels.com/photos/3065244/pexels-photo-3065244.jpeg?auto=compress&cs=tinysrgb&w=800',
